var foo = <elem ng-bind="bar">{foo}</elem>

tpl = <div
        ng-if={
            !contact.isCreatedFromPhoneNumber() && !contact.phone.isUnknown
        }
        class="phone"
        ng-class={{foo: 'foo', bar: 'bar', baz: qux + 10}}>
    </div>


var bar =
    <foo id={item.id} ng-repeat={`friend in friends track by friend.id`}>
...
var template =
    <div class="vm-player" ng-show="enabled">
